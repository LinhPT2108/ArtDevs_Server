...
import static com.artdevs.utils.ResponseMessage.SERVER_ERROR_MESSAGE;
...
public class CloudinaryServiceImpl implements CloudinaryService {
	...
	public Map uploadImage(MultipartFile multipartFile, String uuid) throws Exception {
		...
		Map upload = this.cloudinary.uploader().upload(fileToUpload, params);
	...
	public boolean deleteImage(String cloudinaryPublicId) throws Exception {
		...
		Api.ApiResponse apiResponse = this.cloudinary.api()
