...
public final class ReponseMessageConstants {
	
	private ReponseMessageConstants(){}
    ...
    public static final String FAILURE_POST_UNLIKE_MESSAGE = "Post was not liked from you!";
    ...
    public static final String FAILURE_SAVING_UNSHARE_POST = "Post was not shared from you!";
}
